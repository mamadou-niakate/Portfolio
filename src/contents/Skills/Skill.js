...
function Skill (props) {
    const [skills, setSkill] = useState([
        ...
        { key: 4, label: 'Java', level:13, color:'#f6c90e', image: "https://cdn2.iconfinder.com/data/icons/designer-skills/128/code-programming-java-software-develop-command-language-256.png" },
    ]);
    return ( 
