...
class EditProjectForm extends React.Component {
    ...
    constructor(props) {
        ...
        this.skillTitleRef = createRef();
        this.skillStarsRef = createRef();
        this.skillYearsOfPracticeRef = createRef();
    }

    getSkillToEdit(skill) {
        this.handleOpen()
        /*this.skillTitleRef.current.value = skill.label;
        this.handleOpen();
        console.log(skill);*/
    }
                    ...
                    <div className={styles.paper}>
                        ...
                        <Grid container direction="row" justify="center" alignItems="center">
                            <Grid item xs={12} sm={12} md={12} lg={10} className={styles.groupForm}>
                                <FormGroup>
                                    <FormControl>
                                        ...
                                        <Input ref={this.skillTitleRef} aria-describedby="my-helper-text" />
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={10} className={styles.groupForm}>
                                <FormGroup>
                                    <FormControl>
                                        <Rating ref={this.skillStarsRef} name="hover-feedback" value={this.state.value} precision={0.5}
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={10} className={styles.groupForm}>
                                <FormGroup>
                                    <FormControl> 
                                        ...
                                        <Input ref={this.skillYearsOfPracticeRef} aria-describedby="my-helper-text" />
