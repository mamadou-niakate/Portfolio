...
class AddProject extends Component {
    ...
    constructor(props) {
        ...
        this.EditProjectFormRef = createRef() ;
    }
    ...
    render() {
        return (
            <div>
                <AddProjectForm ref={this.modalRef} />
                <EditProjectForm ref={this.EditProjectFormRef} />
                                    ...
                                    <ListItem key={skill.key}>
                                        ...
                                        <ListItemSecondaryAction>
                                            <IconButton 
                                                ...
                                                onClick={() => {
                                                    this.EditProjectFormRef.current.getSkillToEdit(skill);
                                                }}
                                            > 
                                                <EditIcon /> 
                                            </IconButton>
